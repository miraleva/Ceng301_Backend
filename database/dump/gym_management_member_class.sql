...
CREATE TABLE `member_class` (
  ...
  CONSTRAINT `member_class_ibfk_1` FOREIGN KEY (`member_id`) REFERENCES `member` (`member_id`),
  CONSTRAINT `member_class_ibfk_2` FOREIGN KEY (`class_id`) REFERENCES `gym_class` (`class_id`)
...
INSERT INTO `member_class` VALUES (1,1,'2025-12-17');
